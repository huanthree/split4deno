...
const UUID: string = Deno.env.get("UUID") || "89bf6976-1691-4c51-acc6-9ed1a225bd2e";
const SUB_PATH: string = Deno.env.get("SUB_PATH") || "sub";  //获取订阅路径
const XPATH: string = Deno.env.get("XPATH") || "xhttp";      // 节点路径
const DOMAIN: string = Deno.env.get("DOMAIN") || "huanthree-split4deno-17.deno.dev";         // deno分配的域名必填，不带https://前缀，例如：xxxx.deno.dev      
